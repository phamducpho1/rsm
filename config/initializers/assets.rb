...
Rails.application.config.assets.precompile += %w( employers/notification.scss )
Rails.application.config.assets.precompile += %w( employer/hidepaginate.css )
Rails.application.config.assets.precompile += %w( company/login.js )
...
Rails.application.config.assets.precompile += %w( employer/jquery-ui.css employers/select_step.js employers/apply_block.js
  survey.scss survey.js choose_file.js)
